# AI-102 Domain 1: Plan and manage an Azure AI solution
...
> ⚠️ **AI-102 retires June 30, 2026.** Prioritize this cert accordingly.
...
Days 5–7 directly exercise this domain: AI resource management, monitoring costs, telemetry, and the gateway observability pattern that maps to "monitor an Azure AI resource."
